...
from attention import tt_all_reduce
...
class MLP():
    def __init__(
        ...
        self.w1 = ttnn.Tensor(shape=(3072, 8192), device=mesh_device, dtype=ttnn.bfloat16)
        self.w2 = ttnn.Tensor(shape=(8192, 3072), device=mesh_device, dtype=ttnn.bfloat16)
        self.w3 = ttnn.Tensor(shape=(3072, 8192), device=mesh_device, dtype=ttnn.bfloat16)
